...
{
   ImageIcon icon;
   public Knight(final Location location,final Color color) {
        super(location,color);
        if(color == Color.BLACK) {
             icon =  new ImageIcon(getClass().getClassLoader().getResource("blackKnight.png"));
        } else {
            icon = new ImageIcon(getClass().getClassLoader().getResource("brownKnight.png"));
        }
        super.setIcon(icon);
